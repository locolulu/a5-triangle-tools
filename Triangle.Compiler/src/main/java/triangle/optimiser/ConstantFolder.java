    ...
    public AbstractSyntaxTree foldBinaryExpression(AbstractSyntaxTree node1, AbstractSyntaxTree node2, Operator o) {
        ...
        if ((node1 instanceof IntegerExpression) && (node2 instanceof IntegerExpression)) {
            ...
            if (foldedValue instanceof Integer) {
                ...
                String booleanAsString = ((Boolean) foldedValue).toString();
                Identifier boolID = new Identifier(booleanAsString, node1.getPosition());;

                if (((Boolean) foldedValue).booleanValue()) {
                ...
                VnameExpression ve = new VnameExpression(vname, node1.getPosition());
